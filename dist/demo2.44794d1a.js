...
},{"get-size":"node_modules/get-size/get-size.js","unidragger":"node_modules/unidragger/unidragger.js"}],"node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"js/demo2/draggableImage.js":[function(require,module,exports) {
"use strict";
...
var DraggableImage = /*#__PURE__*/function () {
  function DraggableImage(el) {
    ...
    this.DOM.innerEl = this.DOM.el.querySelector('.img-drag__inner'); // css --overflow value 
    // this will define how much the innerEl can move inside the parent without getting cut off

    this.overflowVal = parseInt(getComputedStyle(this.DOM.innerEl).getPropertyValue('--overflow'), 10); // Dragging position
    ...
    this.draggie = new Draggabilly(this.DOM.el); // Init/Bind events
  ...
  _createClass(DraggableImage, [{
    ...
    value: function initEvents() {
      ...
      this.onPointerDown = function () {
        ...
        _this2.outerScale.current = 1.2;

        _gsap.gsap.to(document.body, {
          duration: 0.5,
          ease: _gsap.Power2.easeOut,
          backgroundColor: '#588186'
        });

        document.body.style.cursor = 'grabbing';
        _this2.DOM.el.style.cursor = 'grabbing';
      };
      ...
      this.onPointerUp = function () {
        ...
        _gsap.gsap.to(document.body, {
          duration: 0.5,
          ease: _gsap.Power2.easeOut,
          backgroundColor: '#a1e0e7'
        });

        document.body.style.cursor = 'default';
        _this2.DOM.el.style.cursor = 'grab';
      };

      this.onMouseEnter = function () {
        if (_this2.DOM.el.classList.contains('is-dragging')) return;
        _this2.innerScale.current = 1.2;
        _this2.outerScale.current = 1.1;
      };

      this.onMouseLeave = function () {
        if (_this2.DOM.el.classList.contains('is-dragging')) return; // Reset
    ...
    value: function layout() {
      ...
      this.DOM.innerEl.style.transform = "translate3d(".concat(this.getInnerTranslation('x'), "px,").concat(this.getInnerTranslation('y'), "px,0) scale3d(").concat(this.innerScale.previous, ", ").concat(this.innerScale.previous, ", 1) rotate3d(1,1,1,0.1deg)"); // The draggable element transform

      this.DOM.el.style.transform = "translate3d(".concat((this.draggingPos.previous.x - this.draggingPos.current.x).toFixed(2), "px,").concat((this.draggingPos.previous.y - this.draggingPos.current.y).toFixed(2), "px,0) scale3d(").concat(this.outerScale.previous, ", ").concat(this.outerScale.previous, ", 1) rotate3d(1,1,1,0.1deg)");
    } // Calculate how much to translate the inner element

  }, {
    key: "getInnerTranslation",
    value: function getInnerTranslation(axis) {
      var distance = this.draggingPos.previous[axis] - this.draggingPos.current[axis];
      var boundaries = {
        distance: {
          min: 0,
          max: 400
        ...
        translation: {
          min: 0,
          max: this.overflowVal / 2 * this.innerScale.previous / this.outerScale.previous
        }
      };
      var translationVal = (0, _MathUtils.map)(Math.abs(distance), boundaries.distance.min, boundaries.distance.max, boundaries.translation.min, boundaries.translation.max);
      translationVal = (0, _MathUtils.clamp)(translationVal, boundaries.translation.min, boundaries.translation.max);
...
},{"./../MathUtils":"js/MathUtils.js","draggabilly":"node_modules/draggabilly/draggabilly.js","gsap":"node_modules/gsap/index.js"}],"node_modules/imagesloaded/imagesloaded.js":[function(require,module,exports) {
var define;
/*!
 * imagesLoaded v4.1.4
...
},{"ev-emitter":"node_modules/ev-emitter/ev-emitter.js"}],"js/demo2/index.js":[function(require,module,exports) {
"use strict";
...
var preloadImages = function preloadImages() {
  return new Promise(function (resolve, reject) {
    imagesLoaded(document.querySelectorAll('.img-drag__inner'), {
      background: true
    }, resolve);
  });
}; // Preload fonts
...
Promise.all([preloadImages(), preloadFonts()]).then(function () {
  _toConsumableArray(document.querySelectorAll('.img-drag')).forEach(function (draggableEl) {
    return new _draggableImage.default(draggableEl);
  });

  document.body.classList.remove('loading');
});
},{"./draggableImage":"js/demo2/draggableImage.js","imagesloaded":"node_modules/imagesloaded/imagesloaded.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
