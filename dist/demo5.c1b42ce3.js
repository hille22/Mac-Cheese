...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"js/demo5/draggableImage.js":[function(require,module,exports) {
"use strict";
...
var DraggableImage = /*#__PURE__*/function () {
  ...
  _createClass(DraggableImage, [{
    ...
    value: function layout() {
      var draggingDistance = (0, _MathUtils.distance)(this.draggingPos.previous.x, this.draggingPos.previous.y, this.draggingPos.current.x, this.draggingPos.current.y); // The inner element transform

      this.DOM.innerEl.style.transform = "scale3d(".concat(this.innerScale.previous, ", ").concat(this.innerScale.previous, ", 1)"); // The draggable element transform

      this.DOM.draggable.style.transform = "scale3d(".concat(this.outerScale.previous, ", ").concat(this.outerScale.previous, ", 1)"); // If the mouse moved more than [this.threshold] then show the next image
...
},{"ev-emitter":"node_modules/ev-emitter/ev-emitter.js"}],"js/demo5/index.js":[function(require,module,exports) {
"use strict";
...
},{"./draggableImage":"js/demo5/draggableImage.js","imagesloaded":"node_modules/imagesloaded/imagesloaded.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
